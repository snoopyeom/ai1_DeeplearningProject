### 2024년 한양대학교 산업융합학부 인공지능1 (정철현 교수님, inbass@hanyang.ac.kr) 기말 프로젝트


## YOLOv5를 활용한 이미지 객체 탐지 프로젝트 (YOLO 입문자를 위한 백서)

#### 2024197648 엄정훈 snoopyeom@gmail.com
#### 2023136527 최주현 choi222a@gmail.com
#### 2018083409 박상홍 tkdghd0351@gmail.com
#### 2021062233 고무성 mike2827@hanyang.ac.kr
...
##### 이미지를 불러와서 작업을 수행합니다.
##### Create Polygons를 선택하여 원하는 이미지를 선택하면 라벨이름을 지정한 후 OK. (단축키: polygons는 Ctrl+N, Rectangle은 Ctrl+R)

![image](https://github.com/snoopyeom/asdf/assets/19545380/a521911b-0b01-4af8-9c1d-d51ef4d603f8)

##### ok를 하면 라인색이 빨간색으로 변하고 Label List에 설정한 vehicle이 입력됩니다. 
...
* 해당 img_list를 train set과 valid set 8:2로 나눕니다.
